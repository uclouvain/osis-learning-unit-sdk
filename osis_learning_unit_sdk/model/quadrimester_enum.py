...
class QuadrimesterEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """QuadrimesterEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["Q1", "Q2", "Q3", "Q1and2", "Q1or2", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["Q1", "Q2", "Q3", "Q1and2", "Q1or2", ]  # noqa: E501
